    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="px-6 py-20 bg-secondary">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-black text-center mb-12">
            O que o paciente decide <span className="text-primary">antes</span> de te chamar
          </h2>

          <div className="grid gap-5 sm:grid-cols-2">
            {/* Perfil Comum */}
            <div className="rounded-2xl border border-border bg-background p-6 sm:p-7">
              <h3 className="text-lg font-bold text-muted-foreground mb-5">Perfil comum</h3>
              <ul className="space-y-4">
                {[
                  "Parece igual a todos",
                  "Não transmite confiança",
                  "Gera dúvida",
                  "Atrai paciente que compara preço",
                ].map((item) => (
            ...
            <div className="rounded-2xl border border-primary/30 bg-background p-6 sm:p-7 relative overflow-hidden">
              ...
              <div className="relative">
                <h3 className="text-lg font-bold text-primary mb-5">Perfil bem posicionado</h3>
                <ul className="space-y-4">
                  {[
                    "Transmite segurança",
                    "Mostra autoridade",
                    "Gera confiança rápida",
                    "Atrai paciente que decide",
                  ].map((item) => (
                    <li key={item} className="flex items-start gap-3">
          ...
          <p className="text-center mt-10 text-lg sm:text-xl font-bold text-muted-foreground">
            Quando não há diferença clara… <span className="text-primary">o paciente escolhe pelo preço.</span>
          </p>
        </div>
      </section>
      ...
      <section className="px-6 py-20">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg text-center mb-12 max-w-xl mx-auto leading-relaxed">
            Ajusto a forma como o seu perfil é percebido para atrair pacientes que <span className="text-primary font-semibold">valorizam</span> o seu trabalho.
          </p>
          <div className="grid gap-4">
            {[
              "Posicionamento estratégico",
              "Percepção de valor",
              "Conteúdo guiado por decisão do paciente",
            ].map((title) => (
              <div
                key={title}
      ...
      <section className="px-6 py-20 bg-secondary">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-black text-center mb-3">
            Como você começa a atrair <span className="text-primary">pacientes melhores</span>
          </h2>
          <p className="text-muted-foreground text-center text-lg mb-12 max-w-xl mx-auto">
            Não é sobre postar mais. É sobre ajustar como o seu perfil é percebido.
          </p>
            ...
            {[
              {
                ...
                text: "Analiso como o seu Instagram está sendo percebido hoje — não por você, mas pelo paciente.",
              },
              {
                step: "02",
                icon: AlertTriangle,
                title: "Identificação de perda invisível",
                text: "Mostro exatamente onde você está afastando pacientes sem perceber.",
              },
              {
                step: "03",
                icon: TrendingUp,
                title: "Ajustes estratégicos",
                text: "Você entende o que mudar para começar a atrair pacientes que valorizam o seu trabalho.",
              },
            ].map((item) => (
              <div
                key={item.step}
              ...
              >
                ...
                <div>
                  <span className="text-xs font-bold text-primary tracking-widest uppercase mb-1 block">Passo {item.step}</span>
      ...
      <section className="px-6 py-24">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-3xl sm:text-4xl md:text-5xl font-black leading-tight">
            Seu perfil pode estar te fazendo parecer{" "}
      ...
      <section id="formulario" className="px-6 py-20">
        <div className="max-w-lg mx-auto">
          <div className="rounded-2xl border border-primary/20 bg-card p-8 sm:p-10" style={{ boxShadow: "0 0 60px -12px hsl(24 95% 53% / 0.15)" }}>
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground">Vou analisar seu perfil e entro em contato em breve.</p>
              </div>
            ) : (
              <>
                <h2 className="text-2xl sm:text-3xl font-black text-center mb-2">
                  Solicite uma análise do seu perfil
                </h2>
                <p className="text-muted-foreground text-center mb-8">
                  Preencha abaixo e eu entro em contato com você
                </p>
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <input
                    type="text"
                    name="instagram"
                    placeholder="Instagram da clínica ou perfil"
                    required
                    className="w-full px-4 py-3.5 rounded-lg bg-secondary border border-border text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-colors"
                  />
                  <input
                  ...
                  <textarea
                    name="incomoda"
                    placeholder="O que mais te incomoda no seu perfil hoje?"
                    rows={4}
      ...
      <footer className="px-6 py-10 border-t border-border text-center">
        <p className="text-muted-foreground text-sm">© {new Date().getFullYear()} · Todos os direitos reservados</p>
      </footer>
    </div>
  );
};
